...
public class EmojiMosaicActivity extends BaseActivity {
        ...
        Observable.just(oldPicPath)
                ...
                .flatMap(new Function<String, ObservableSource<Bitmap>>() {
                    ...
                    public ObservableSource<Bitmap> apply(String s) throws Exception {
                        ...
                        EmojiMosaic emojiMosaic = new EmojiMosaic();
                        Bitmap generate = emojiMosaic.generate(EmojiMosaicActivity.this, bis, bos);
                ...
                .subscribe(new Consumer<Bitmap>() {
                    ...
                    public void accept(Bitmap s) throws Exception {
                        dismissDialog();
                        GlideApp.with(EmojiMosaicActivity.this)
                                .load(s)
                                .into(ivShow);
                    }
